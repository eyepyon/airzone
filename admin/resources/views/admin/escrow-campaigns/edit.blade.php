            ...
            <form action="{{ route('admin.escrow-campaigns.update', $campaign->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="is_active"
                                       name="is_active" {{ old('is_active', $campaign->is_active) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('lock_days') is-invalid @enderror"
                                   id="lock_days" name="lock_days" value="{{ old('lock_days', $campaign->lock_days) }}"
                                   min="1" required>
                            @error('lock_days')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('max_participants') is-invalid @enderror"
                                   ...
                                   value="{{ old('max_participants', $campaign->max_participants) }}" min="1">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('nft_reward_name') is-invalid @enderror"
                           ...
                           value="{{ old('nft_reward_name', $campaign->nft_reward_name) }}" required>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('nft_reward_description') is-invalid @enderror"
                              ...
                              rows="3">{{ old('nft_reward_description', $campaign->nft_reward_description) }}</textarea>
                ...
                <div class="mb-3">
                    ...
                    <input type="url" class="form-control @error('nft_reward_image_url') is-invalid @enderror"
                           ...
                           value="{{ old('nft_reward_image_url', $campaign->nft_reward_image_url) }}">
